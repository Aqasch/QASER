...
from utils import dictionary_of_hcxcz_actions, dict_of_actions_revert_q_hcxcz


class DeepQHCZCX(object):
    ...
    def __init__(self, conf, action_size, state_size, device):
        ...
        self.translate = dictionary_of_hcxcz_actions(self.num_qubits)
        self.rev_translate = dict_of_actions_revert_q_hcxcz(self.num_qubits)
