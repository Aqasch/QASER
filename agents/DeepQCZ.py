...
from utils import dictionary_of_actions, dict_of_actions_revert_q, dict_of_actions_revert_q_clifford, dictionary_of_cz_actions, dict_of_actions_revert_q_cz
...
class DQNCZ(object):
    ...
    def __init__(self, conf, action_size, state_size, device):
        ...
        self.translate = dictionary_of_cz_actions(self.num_qubits)
        self.rev_translate = dict_of_actions_revert_q_cz(self.num_qubits)
